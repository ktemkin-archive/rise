...
(function( $ ) {
  $.fn.niceFileField = function() {
    this.each(function(index, file_field) {
      ...
      var label = file_field.attr("data-label") || "<i class=\"icon-folder-open\">";
      var value = file_field.attr("value") || '';
      var new_id = 'pretty_' + file_field.attr("id");

      file_field.css({"display": "none"});
      file_field.after("<div class=\"nice_file_field input-append\"><input id=\"" + new_id + "\" class=\"input-xxlarge\" value=\"" + value + "\" type=\"text\"><a class=\"btn\">" + label + "</a></div>");
